...
def load_sheet_settings(spreadsheet):
    ...
    try:
        ...
        logger.info(f"設定から取得したキー - 友達リスト: {friend_data_key}, 相談フラグマスタ: {consult_flag_key}, 相談転記先: {transfer_list_key}")
        ...
        return friend_sheet_name, consult_sheet_name, transfer_sheet_name
